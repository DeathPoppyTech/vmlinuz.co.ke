...
module.exports = (req, res) => {
  ...
  if (isTerminal) {
    ...
    return res.status(200).send(RAW_SCRIPT);
  }
...
<head>
  ...
  <title>MTKClient Installer - vmlinuz.co.ke</title>
  <style>
    :root {
      --bg: #0d1117;
      --card: #161b22;
...
--------------------------------------------------------------------------------------</pre>
    ...
    <div class="card">
      <h1>MTKClient Linux Installer</h1>
      <p>Issues? Email poppy@poppy.satu.zip or DM @notpoppy_rblx on Discord:</p>
      <div class="cmd-box">
        <code>curl -sSL https://vmlinuz.co.ke/bash/mtkclient.sh | bash</code>
      </div>
    </div>

    <div class="footer">
      Linux only • For Windows, use <a href="https://github.com/codefl0w/mtkclient-windows-installer" style="color: var(--accent);">codefl0w's installer</a>
    </div>
  </div>
</body>
</html>`;
